...
export default function Wishlist({ toggleWishlist }) {
  ...
  const handleMoveToCart = () => {
    ...
    // Add your move to cart logic here if needed
  };
    ...
    <div className="fixed inset-0 z-50 bg-black/70 flex justify-end">
      <div className="bg-white w-full max-w-md h-full flex flex-col">
        ...
        <div className="flex justify-between items-center p-5 border-b border-gray-200">
          <h2 className="text-xl font-medium text-[#3c003c]">Wishlist</h2>
          <button
        ...
        <div className="border-t px-6 py-6 text-[#3c003c]">
          ...
          >
            <span className="mr-2">🛒</span> Move to Cart
          </button>
        </div>
      </div>
    </div>
