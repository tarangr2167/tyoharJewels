...
const Footer = () => {
  ...
  return (
    <footer className="bg-white">
      {/* Newsletter Section */}
      <div className="container mx-auto px-4 py-8 md:px-[106px]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="w-full md:w-2/3">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-[#12113d] text-white px-6 py-3 rounded-full hover:bg-[#5c0239] transition-colors"
              >
                Subscribe
              </button>
            </form>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <button
                    onClick={() => handleNavigation("/ourtrust")}
                    className="hover:underline"
                  >
                    OUR TRUST
                  </button>
